"""
Django settings for frosty_grass_39828 project.
...
ROOT_URLCONF = 'frosty_grass_39828.urls'
...
WSGI_APPLICATION = 'frosty_grass_39828.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "frosty_grass_39828 API",
    "DESCRIPTION": "API documentation for frosty_grass_39828 App",
    "VERSION": "v1",
}
